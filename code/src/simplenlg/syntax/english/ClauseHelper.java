 ...
 * 
 */
//CRI: cambiato visibilitá per creare classe figlia ClauseHelperIta
//necessario per usare visibilità protected e non public...ricordiamoci
//che la API sarà utilizzata e non va bene lasciare certi metodi public
public abstract class ClauseHelper {
	 ...
	 */
	//CRI: cambiato visibilitá per richiamare questo metodo da clauseHelperItalian
	protected static NLGElement realise(SyntaxProcessor parent, PhraseElement phrase) {
	 ...
	 */
	//CRI cambiata visibilità
	protected static void addEndingTo(PhraseElement phrase,
