...
//				deVerb.setComplement(frontVG);
	...
	/**
	 * Adds negation adverbs after the verb e.g., <em>più, affatto, mica</em> to the stack if the phrase is negated
	 * and the axuiliary negation is set by the user.
	 * The method is changed from the french method createPas
	 * 
	 * TO DO: 
	 * 1. controllare un insieme di avverbi di negazione
	 * 2. cambiare feature aux negation in adv negation?
	 * 
	 * @param phrase
	 *            the <code>PhraseElement</code> representing this noun phrase.
	 * @param vgComponents
